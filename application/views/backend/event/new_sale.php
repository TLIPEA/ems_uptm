                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Nueva Preventa en <?=$event[0]->Name?>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
									<?=form_open('sale/new_sale/'.$event[0]->Id.'/2', array('role'=>'form','autocomplet'=>'off','class'=>'form-horizontal'))?>
									...
									<?php endif;?>
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<input type="text" class="form-control" id="Description" name="Description" placeholder="Nombre de la Preventa" required="" value="<?=set_value('Description')?>">
											</div>
                                        </div>
										...
										<div class="form-group">
										  <label for="Start_Date" class="col-md-2">Fecha Inicio</label>
											<div class="col-md-10">
												<input type="text" class="form-control" data-date-format="YYYY-MM-DD" id="Start_Date" name="Start_Date" placeholder="Fecha Inicio" readonly="readonly" required="" value="<?=set_value('Start_Date')?>">
											</div>
										</div>
										...
										<div class="form-group">
										  <label for="End_Date" class="col-md-2">Fecha Fin</label>
											<div class="col-md-10">
												<input type="text" class="form-control" data-date-format="YYYY-MM-DD" id="End_Date" name="End_Date" placeholder="Fecha Fin" readonly="readonly" required="" value="<?=set_value('End_Date')?>">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<label class="radio-inline col-md-3">
												    <input type="radio" name="Status" id="Status1" value="Active" <?=set_value('Status')=='Active' ? 'checked=""':''?>>Activa
												</label>
												<label class="radio-inline col-md-3">
												    <input type="radio" name="Status" id="Status2" value="Off" <?=set_value('Status')=='Off' ? 'checked=""':''?>> Inactiva
												</label>
											</div>
                                        </div>
