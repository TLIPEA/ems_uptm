                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
									<?=form_open('events/new_place/'.$event[0]->Id.'/2', array('role'=>'form','autocomplet'=>'off','class'=>'form-horizontal'))?>
									...
									<?php endif;?>
										...
										<div class="form-group">
										  <label for="Name" class="col-md-2">Nombre</label>
											<div class="col-md-10">
												<input type="text" class="form-control" data-date-format="YYYY-MM-DD" id="Name" name="Name" placeholder="Nombre del Lugar" required="" value="<?=set_value('Name')?>">
											</div>
										</div>
